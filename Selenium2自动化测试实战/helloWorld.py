...
@LastEditors: liuhua
@LastEditTime: 2019-10-10 15:15:37
'''
#!/usr/bin/env python
...
if __name__ == '__main__':
    report_path = r"C:\Users\liuhua2\Desktop\result\report.html"
    ...
    # suite.addTests(map(login_gb, ['test_baidu_new', 'test_baidu']))# 少量用例添加执行
    # suite.addTest(login_gb('test_baidu_new'))# 少量用例添加执行
