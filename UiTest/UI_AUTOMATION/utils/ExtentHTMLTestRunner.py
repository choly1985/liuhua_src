...
"""
    ...
    <section id='controls'>
            <div class='controls grey lighten-4'>
                ...
                <div class='chip transparent'>
                    <a class='dropdown-button tests-toggle' data1-activates='tests-toggle' data1-constrainwidth='true'
                       data1-beloworigin='true' data1-hover='true' href='#'>
                ...
                <!-- category toggle -->
                <div class='chip transparent'>
                    <a class='dropdown-button category-toggle' data1-activates='category-toggle'
                       data1-constrainwidth='false' data1-beloworigin='true' data1-hover='true' href='#'>
                ...
                <div id='charts-row' class='row nm-v nm-h'>
                    ...
                    <div class='col s12 m6 l6 np-h'>
                        <div class='card-panel nm-v'>
                            ...
                            <div class='block text-small'>
                            <span id="pass_suites" class='tooltipped' data1-position='top'>
                            </span>
                            </div>
                            <div class='block text-small'>
                                <span id="fail_suites" class='strong tooltipped' data1-position='top'></span> suite(s)
                                failed
                            </div>
                        </div>
                    </div>
    ...
    <div class='test-content hide'>
        ...
        <ul class='collapsible node-list' data1-collapsible='accordion'>
