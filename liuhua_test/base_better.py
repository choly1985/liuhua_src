...
class login_gb(unittest.TestCase):
    ...
    def test_login_gb(self):
        ...
        WebDriverWait(
            self.driver,
            20).until(lambda x: x.find_element_by_id('js-btnSubmit')).click()

        # 收藏页添加物品至购物车

        above = WebDriverWait(
            self.driver, 20).until(lambda x: x.find_element_by_xpath(
                '//*[@id="ucenter_content"]/div/div/ul/li[1]/a/img'))
        print(above)
        ActionChains(self.driver).move_to_element(above).perform()
        WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath(
            '//*[@id="ucenter_content"]/div/div/ul/li[1]/a/div/span[1]/i')
        ).click()
        time.sleep(2)
...
=======
        WebDriverWait(
            self.driver, 8).until(lambda x: x.find_element_by_css_selector(
                "div.cart_checkoutBtnBox>a.btn.middle.strong.proceed_checkout")
...
=======
        ...
        WebDriverWait(
            ...
            "div.address_data>input[name='firstName'][class='address_input']")
        ).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
        ...
        WebDriverWait(
            ...
            "div.address_data>input[name='lastName'][class='address_input']")
        ).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
        ...
        WebDriverWait(
            self.driver, 10).until(lambda x: x.find_element_by_css_selector(
                "div.address_data>input[name='email'][class='address_input']")
        ).clear()
        WebDriverWait(
            self.driver, 8).until(lambda x: x.find_element_by_css_selector(
                "div.address_data>input[name='email'][class='address_input']")
        ).send_keys("lh100@qq.com")

        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='postalCode'][class='address_input']")
        ).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
        ...
        WebDriverWait(
            ...
            "div.address_data>input[name='addressLine1'][class='address_input']"
        )).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='addressLine1'][class='address_input']"
        )).send_keys("addressline1")

        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='addressLine2'][class='address_input']"
        )).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='addressLine2'][class='address_input']"
        )).send_keys("addressline2")
>>>>>>> 2885262ae01eef3639281dd554e49712ad40455a

        # 点击编辑国家下拉框
        WebDriverWait(self.driver, 8).until(lambda x: x.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/form/div[7]/div[1]/div/p/i"
        )).click()

        # 编辑国家
        WebDriverWait(self.driver, 8).until(lambda x: x.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/form/div[7]/div[1]/div/div/ul/li[45]"
        )).click()

        # 点击编辑州省下拉框
        WebDriverWait(self.driver, 8).until(lambda x: x.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/form/div[8]/div[1]/div/p/i"
        )).click()

        # 编辑州省
        WebDriverWait(self.driver, 8).until(lambda x: x.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/form/div[8]/div[1]/div/div/ul/li[1]"
        )).click()

        # 点击编辑城市下拉框
        WebDriverWait(self.driver, 8).until(lambda x: x.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/form/div[9]/div[1]/div/p/i"
        )).click()

        # 编辑城市
        WebDriverWait(self.driver, 8).until(lambda x: x.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/form/div[9]/div[1]/div/div/ul/li[1]"
        )).click()

        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='nationalIdNumber'][class='address_input']"
        )).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='nationalIdNumber'][class='address_input']"
        )).send_keys("1591579971")

        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='middleName'][class='address_input']")
        ).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
        ...
        WebDriverWait(
            ...
            "div.address_data>input[name='taxNumber'][class='address_input']")
        ).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
        ...
        WebDriverWait(
            ...
            "div.address_data>input[name='passportNo'][class='address_input']")
        ).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
        ...
        WebDriverWait(
            ...
            "div.address_data>input[name='passportSerial'][class='address_input']"
        )).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
        ...
        WebDriverWait(
            ...
            "div.address_data>input[name='passportIssueDate'][class='address_input']"
        )).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='passportIssueDate'][class='address_input']"
        )).send_keys("12/12/2019")

        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='issuingAgency'][class='address_input']"
        )).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
        ...
        WebDriverWait(
            ...
            "div.address_data>input[name='birthDay'][class='address_input']")
        ).clear()
        WebDriverWait(
            self.driver, 8
        ).until(lambda x: x.find_element_by_css_selector(
            "div.address_data>input[name='birthDay'][class='address_input']")
        ).send_keys("2016-05-22")

        WebDriverWait(self.driver, 15).until(lambda x: x.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/form/div[19]/a[2]"
        )).click()
        time.sleep(3)
        WebDriverWait(self.driver, 15).until(lambda x: x.find_element_by_xpath(
        ...
        WebDriverWait(
            ...
            "span[class='compCheckbox_shape checked'][paychannel='PAYPAL']>i.compCheckbox_check"
        )).click()

        WebDriverWait(
            self.driver, 20).until(lambda x: x.find_element_by_css_selector(
                "div.pc_order_total>i.placeOrder.btn.block.toPayBtn")).click()

        self.driver.switch_to.frame(
            WebDriverWait(self.driver,
                          20).until(lambda x: x.find_element_by_css_selector(
                              "iframe[name='injectedUl']")))

        WebDriverWait(self.driver, 8).until(
            lambda x: x.find_element_by_css_selector("input#email")).clear()
        WebDriverWait(self.driver,
                      8).until(lambda x: x.find_element_by_css_selector(
